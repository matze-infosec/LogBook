...
512	 NT is starting up
513	 is shutting down
...
848	The following policy was active when the  Firewall started
849	An application was listed as an exception when the  Firewall started
850	A port was listed as an exception when the  Firewall started
851	A change has been made to the  Firewall application exception list
852	A change has been made to the  Firewall port exception list
853	The  Firewall operational mode has changed
854	The  Firewall logging settings have changed
855	A  Firewall ICMP setting has changed
856	The  Firewall setting to allow unicast responses to multicast/broadcast traffic has changed
857	The  Firewall setting to allow remote administration, allowing port TCP 135 and DCOM/RPC, has changed
858	 Firewall group policy settings have been applied
859	The  Firewall group policy settings have been removed
860	The  Firewall has switched the active policy profile
861	The  Firewall has detected an application listening for incoming traffic
